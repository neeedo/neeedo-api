...
//import io.sphere.sdk.products.{Product, ProductBuilder, ProductCatalogDataBuilder, ProductDataBuilder, ProductVariantBuilder}
...
//        esOfferService.createOffer(offer) returns Future.successful(offer)
//
